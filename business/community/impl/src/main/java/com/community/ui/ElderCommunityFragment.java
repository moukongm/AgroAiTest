...
public class ElderCommunityFragment extends BaseFragment<FragmentCommunityElderBinding> {
    ...
    @Override
    public FragmentCommunityElderBinding getViewBinding(LayoutInflater inflater, ViewGroup container) {
        return FragmentCommunityElderBinding.inflate(inflater, container, false);
    }
